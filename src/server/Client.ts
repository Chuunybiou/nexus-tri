...
import { DEFAULT_FACTION, Faction } from "../core/game/Factions";
...
export class Client {
  ...
  constructor(
    ...
    // The faction picked at join. Defaulted so a client from a build that
    // predates the lobby picker still lands on the balance anchor.
