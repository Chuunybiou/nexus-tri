...
export class PlayerInfo {
  ...
  constructor(
    ...
    // Which of the three asymmetric factions this player fields. Defaulted
    // rather than required: replays, old wire messages and every bot/nation
    // spawner predate factions, and Vanguard is balance-neutral, so they all
    // keep behaving exactly as before.
    public readonly faction: Faction = DEFAULT_FACTION,
  ) {
