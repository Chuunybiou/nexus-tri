...
export class GraphicsAdvancedSettings extends LitElement {
  ...
  private currentClassicBotColors(): boolean {
    // Same default as ThemeProvider.current(), or the checkbox would show
    // the opposite of what the map is drawing.
    return this.userSettings.graphicsOverrides().classicBotColors ?? true;
  }
