      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- AGPL v3, article 13 : un joueur qui utilise le jeu a travers le
                 reseau doit pouvoir en obtenir le code source. -->
            <a
              href="https://github.com/Chuunybiou/nexus-tri"
              target="_blank"
              rel="noopener"
              class="hover:text-white transition-colors"
